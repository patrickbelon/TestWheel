//
//  beFirstViewControllerNavViewController.m
//  BluetoothTest
//
...
#import "beFirstViewControllerNavViewController.h"

@interface beFirstViewControllerNavViewController ()

@end

@implementation beFirstViewControllerNavViewController
@synthesize tabBar;
...
- (void)viewDidLoad
{
    ...
    UIImage *selectedTab = [UIImage imageNamed: @"tabBarSelected"];
    selectedTab = [selectedTab imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    
    UIImage *regularTab = [UIImage imageNamed:@"tabRegular"];
